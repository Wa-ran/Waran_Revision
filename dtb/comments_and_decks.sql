...
ALTER TABLE users ADD hide_card TINYINT(1) DEFAULT '1', ADD chrono_card TINYINT(1) DEFAULT '1', ADD fast_mode TINYINT(1) DEFAULT '1', ADD dark_mode TINYINT(1) DEFAULT NULL, ADD hide_form_modal TINYINT(1) DEFAULT NULL, ADD show_form_options TINYINT(1) DEFAULT NULL;
